...
const POST_URL_FIELD_DESCRIPTIONS: Record<
  Exclude<PostUrlField, 'slug'>,
  string
> = {
  ...
  return (
    <>
        ...
        <Form.Field
          ...
          render={({ field }) => (
            <Form.Item>
              ...
              <Form.Description>{t('slug-leave-empty-desc')}</Form.Description>
              <Form.Message />
            </Form.Item>
          )}
        />
      ...
      {canShowUrlField && generatedPostUrlField && (
        <Form.Item>
          <Form.Label>
            {POST_URL_FIELD_LABELS[generatedPostUrlField]}
          </Form.Label>
          <Form.Control>
            <div className="flex items-center gap-2">
              <Input
      ...
      <Form.Field
        ...
        render={({ field }) => (
          <Form.Item>
            ...
            <Form.Description>{t('featured-desc')}</Form.Description>
            <Form.Control>
              <Switch

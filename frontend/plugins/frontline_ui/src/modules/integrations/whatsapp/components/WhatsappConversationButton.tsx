 ...
 * header — the WhatsApp counterpart to PlivoConversationCallButton, on the
 * identical reasoning its own docstring gives: an agent handling a call or
 * an email often needs to reach the same customer on another channel, so
 * calling is offered everywhere rather than only on voice threads. WhatsApp
 * was missing that parity.
 *

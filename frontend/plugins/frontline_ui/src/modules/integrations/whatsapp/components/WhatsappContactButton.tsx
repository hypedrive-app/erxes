...
/**
 * "Message on WhatsApp" from the customer record — the WhatsApp equivalent
 * of PlivoContactCallButton, on the same relation widget.
 *
 ...
 *
 * Unlike Plivo's button, this does not pre-validate the customer's number:

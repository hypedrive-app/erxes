              ...
              {step === 3 && (
                <div className="space-y-6">
                  ...
                  <button
                    type="button"
                    onClick={addTraveler}
                    className="flex items-center gap-2 px-4 py-2 border-2 border-dashed border-border rounded-lg w-full justify-center text-muted-foreground hover:border-primary hover:text-primary transition-colors"
                  >
                    <IconPlus size={18} />
                    Аялагч нэмэх
                  </button>
              ...
              {step === 4 && (
                <div className="space-y-6">
                  ...
                  <div className="p-4 bg-muted rounded-lg space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div className="text-muted-foreground">Очих улс:</div>
                      <div>{destinationCountry}</div>
                      <div className="text-muted-foreground">Бүтээгдэхүүн:</div>
                      ...
                      <div className="text-muted-foreground">Аялагчдын тоо:</div>
